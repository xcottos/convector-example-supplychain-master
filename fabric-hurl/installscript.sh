...
echo "Instantiating Chaincode at org1"
...
/Users/luca/Projects/GitHubProjects/cloned/convector-example-supplychain-master/fabric-hurl/fabric-binaries/1.3.0/bin/peer chaincode instantiate     -C ch1    -n supplychainchaincode    -v 1.0    -c '{"Args":["init",""]}'    -o localhost:7050    --cafile /Users/luca/Projects/GitHubProjects/cloned/convector-example-supplychain-master/fabric-hurl/artifacts/crypto-config/ordererOrganizations/hurley.lab/orderers/orderer.hurley.lab/msp/tlscacerts/tlsca.hurley.lab-cert.pem

    # -P "OR('org1.client','org2.client')"
echo "Instantiated Chaincode at org1"

#mkdir -p /Users/luca/Projects/GitHubProjects/cloned/convector-example-supplychain-master/fabric-hurl/tasks
#touch /Users/luca/Projects/GitHubProjects/cloned/convector-example-supplychain-master/fabric-hurl/tasks/installchaincode.sh.successful
